(function() {
  ...
  Alchemy.prototype.generateLayout = function(instance) {
    ...
    return function(start) {
      ...
      return a.force = d3.layout.force().size([conf.graphWidth(), conf.graphHeight()]).theta(0).gravity(a.layout.gravity()).friction(a.layout.friction()).nodes(a.elements.nodes.d3).links(a.elements.edges.d3).linkDistance(function(link) {
